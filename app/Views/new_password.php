        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                    <h1>Password Baru</h1>
                    <h2>Masukkan password baru untuk membuat kata sandi Anda.</h2>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <form action="<?php echo base_url('/reset_password') ?>" method="post">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                <label class="form-label">Ubah Password untuk <span class="badge bg-success"> <?php echo $email; ?></span></label>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Password</label>
                                <input type="password" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('password')) ? 'is-invalid'  : ''; ?>" name="password" value="<?php echo old('password'); ?>" id="email">
                                <!-- pesan validasi -->
