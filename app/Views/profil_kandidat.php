            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start"><a
                            ...
                            class="btn-get-started scrollto">Informasi Detail</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200"> <img
                        src="<?= base_url() ?>/assets/img/hero-img1.png" class="img-fluid animated" alt="ferienjobs"
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>Pantau terus informasi status Anda di halaman ini. Jangan lupa follow dan share media sosial
                        kami.<br>
                        <span class="social-links"> <a href="https://www.facebook.com/cvgenoverseas"
                                class="facebook btn btn-primary" target="_blank"><i class="bx bxl-facebook"></i></a> <a
                                href="https://www.instagram.com/cvgencom/" class="instagram btn btn-danger"
                                target="_blank"><i class="bx bxl-instagram"></i></a></span>
                        <br>Butuh bantuan?
                    </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-links">
                        ...
                        <div class="social-links mt-3"> <a href="https://www.facebook.com/cvgenoverseas"
                                ...
                                target="_blank"><i class="bx bxl-linkedin"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
