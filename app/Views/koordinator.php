        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                    <h1>Koordinator</h1>
                    <h2>Adalah tim yang terverifikasi untuk mengkoordinir calon kandidat program Ferienjobs, bergabunglah bersama kami sebagai Koordinator Program Ferienjobs ke Jerman Batch-02 tahun 2023-2024.</h2>
        ...
        <section class="about">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Daftar Sebagai Koordinator</h2>
                </div>
                <div class="row content">
                    <form action="<?= base_url() ?>/simpan-koordinator" method="POST">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-lg-6">
                                <h5>Biodata</h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="pekerjaan" id="pekerjaan" aria-label="pekerjaan" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="jk" name="jk" id="jk" required>
                                                <option value="" selected disabled>Pilihan</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="wa" id="wa" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h5>Akun Koordinator</h5>
                                <hr>
                                <div class="row">
